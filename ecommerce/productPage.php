...
//            include 'Product.php';
            ...
            $selectProductQuery = $pdo->prepare("SELECT * FROM `product` WHERE productId = $productId");
            $selectProductQuery->execute();
            //$selectProductQuery->setFetchMode(PDO::FETCH_CLASS,'Product');
            $product=$selectProductQuery->fetch();
            ?>
            <div class="col-md-6">
            <img src="./img/<?=$product['picture']?>" height="270" width="550" alt="Product Name" class="img-fluid">
            </div>
            <!-- /Product main img -->
            ...
            <div class="col-md-5">
                <div class="product-details">
                    <h2 class="product-name"><?=$product['brand'].' '.$product['productName']?></h2>
                    <div>
...
<!--                        <a class="review-link" href="#">10 Review(s) | Add your review</a>-->
                    ...
                    <div>
                        <h3 class="product-price"><?=$product['price']?> LE
